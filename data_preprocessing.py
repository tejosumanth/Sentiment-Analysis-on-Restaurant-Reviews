...
# Train the model
model.fit(X_train, y_train, validation_data=(X_test, y_test), epochs=20, batch_size=64)# fix: NLTK wordnet not downloaded before lemmatizer init — add nltk.download guard
