...
# Train the model
model.fit(X_train, y_train, validation_data=(X_test, y_test), epochs=20, batch_size=64)# fix: label encoding inconsistency between train and test sets — unified encoder
