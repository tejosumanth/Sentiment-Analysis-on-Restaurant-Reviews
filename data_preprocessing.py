...
# Train the model
model.fit(X_train, y_train, validation_data=(X_test, y_test), epochs=20, batch_size=64)# chore: add requirements.txt with transformers, tensorflow, sklearn, nltk, pandas
